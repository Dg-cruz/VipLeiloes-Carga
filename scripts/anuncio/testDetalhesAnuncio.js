...
import { ATUALIZACAO_URL, ANUNCIO_ID } from '../../config/detalhes_anuncio.js'; // importa as URLs do arquivo de configuração
...
export default function () {
  let updateResponse = http.get(`${ATUALIZACAO_URL}/${ANUNCIO_ID}`, params);
